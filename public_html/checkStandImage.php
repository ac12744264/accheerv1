      ...
      <div class="container" id="maincontainer" style="padding:0px; margin:0px;">
        ...
        <div class="container" id="start-container">
          <div class="row">
            ...
            <div class="col-md-1">
              <button id="start" class="btn btn-primary" style="margin-top:24px;">Start</button>
            </div>
          </div>
          <div id="start-error-message-row" class="row" hidden>
            <p id="start-error-message"></p>
          </div>
        </div>
        <br/>
        <div class="container" id="stop-container" hidden>
          <div class="row">
            <div class="col-md-3">
        ...
        <br/>
        <div class="container" id="table-container" hidden>
          <table>
            <tbody>
              <?php
