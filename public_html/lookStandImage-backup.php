...
<html>
  ...
  <body>
      <div class="container" id="maincontainer">
        ...
        <div class="row">
          <div class="col-xs-6 left-container" style="border-right: solid 1px black; padding: 15px;">
            <!-- <div class="col-xs-12 card card-waiting">
              <div class="row" style="padding-left: 10px; padding-right: 10px;">
                ...
                <div class="col-xs-5">
                  ...
                  <div class="row">
                    <span>กษิเดช มุ่งนิรันดร์</span>
                  </div>
                  <div class="row">
                    <span>ม.1/1 เลขที่ 1</span>
                  </div>
                </div>
                <div class="col-xs-5">
                  <div class="row">
          ...
          <div class="col-xs-6 right-container" style="padding: 15px;">
          <?php
              if(isset($results)){
                foreach($results as $key => $value){
                  if($value['seatColumn']>25) {
